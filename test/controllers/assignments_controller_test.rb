...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference("Assignment.count") do
      post assignments_url, params: { assignment: { course_name: @assignment.course_name, due_date: @assignment.due_date, estimated_hours: @assignment.estimated_hours, synced_to_calendar: @assignment.synced_to_calendar, title: @assignment.title } }
    end
